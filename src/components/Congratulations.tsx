...
export default function Congratulations() {
  return (
    ...
    <div className="w-full  flex justify-center">
      <div className="  max-md:w-[300px] max-md:h-[400px] max-md:py-6  w-full h-[500px] rounded-4xl text-[#1D2134] flex flex-col justify-center items-center ">
        ...
        <Link to="/">
          <button className=" max-md:mt-15  mt-5 rounded-4xl border-2 py-3 px-6 md:py-3 md:px-13 border-[#1D2134] text-base md:text-lg lg:text-xl font-bold  hover:bg-[#1D2134] hover:text-white transition-colors duration-200">
            Home
          </button>
        </Link>
      </div>
