...
const EditEventForm = ({ showForm, setShowForm, event }: createEventFormProps) => {
  ...
  const formik = useFormik({
        ...
        price: String(event.price),  // convert to string to match Yup.number
        category: event.category,
        image: undefined,  // clear initial image value
        },
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      updateEvent({ id: event._id, data: eventPayload });
      setShowForm(false);
      resetForm();
    },
  });
